...
import CheckoutSteps from '../components/CheckoutSteps';
import { Link } from 'react-router-dom';
import { createdOrder, payOrder } from '../actions/OrderAction';
import { ORDER_CREATE_RESET, ORDER_PAY_RESET } from '../constants/OrderConstant';
import LoadingBox from "../components/LoadingBox";
import MessageBox from "../components/MessageBox";
                ...
                <div className="col-7">
                    <div className="card-body">
                        <ul>
                            ...
                            <li><p>Items</p><p>${cart.itemsPrice.toFixed(2)}</p></li>
                            <li><p>Shipping</p><p>${cart.shippingPrice.toFixed(2)}</p></li>
                            <li><p>Tax</p><p>${cart.taxPrice.toFixed(2)}</p></li>
                            <li><p><strong>Total</strong></p><p><strong>${cart.totalPrice.toFixed(2)}</strong></p></li>
                            <li>
                                <button type="button" onClick={placeOrder} disabled={cart.cartItems.length === 0} className="placeorder-btn">
                                    Place order
                                </button>
                            </li>
                            {loading && <LoadingBox></LoadingBox>}
